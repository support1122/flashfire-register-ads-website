...
export const registerHeroData: HeroSectionData = {
  ...
  headlineLine1: "Land More Interview Calls",
  headlineLine2: "Without",
  headlineHighlight: "Spending",
  headlineSuffix: "Hours Applying",
  description:
    "Our team finds relevant jobs, AI helps optimize your resume, and we manually apply on your behalf so you can focus on interviews.",
  cta: { label: "Book a Free Career Call", href: "/register" },
