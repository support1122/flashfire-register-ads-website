...
export default function WhatsAppFloatingButton() {
  return (
    <button
      ...
      className="fixed right-4 z-[75] rounded-full bg-green-500 p-3 text-white shadow-lg transition-all hover:bg-green-600 hover:shadow-xl sm:right-6 sm:p-4 max-[900px]:bottom-[calc(5.75rem+env(safe-area-inset-bottom,0px))] min-[901px]:bottom-4 sm:bottom-6"
