...
export default function WhatsAppFloatingButton() {
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-[60] rounded-full bg-green-500 p-3 text-white shadow-lg transition-all hover:bg-green-600 hover:shadow-xl sm:bottom-6 sm:right-6 sm:p-4"
